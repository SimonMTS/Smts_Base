...
<div class="row">
	<div class="col">
		...
		<a class="btn btn-primary mb-4" href="<?= Smts::$config['BaseUrl'] ?>dev/filegen/model" >Start</a>
		...
		<a class="btn btn-primary mb-4" href="<?= Smts::$config['BaseUrl'] ?>dev/filegen/crud" >Start</a>
	</div>
</div>