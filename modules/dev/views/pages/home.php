...
<div class="row">
	<div class="col">
		...
		<a class="btn btn-primary mb-4" href="<?= Smts::$config['BaseUrl'] ?>dev/filegen" >Start</a>

		<h2>Database Setup</h2>
		<p>Here you can (re)load the database with test data.</p>
		<a class="btn btn-primary mb-4" href="<?= Smts::$config['BaseUrl'] ?>dev/setup/init/pw" >Start</a>
	</div>
</div>