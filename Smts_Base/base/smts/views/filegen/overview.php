<div class="row">
	<div class="col-md-12">
		...
		<a class="btn btn-default" href="<?= $GLOBALS['config']['base_url'] ?>smts/filegen/model" >Start</a>
		...
		<a class="btn btn-default" href="<?= $GLOBALS['config']['base_url'] ?>smts/filegen/crud" >Start</a>
	</div>
</div>